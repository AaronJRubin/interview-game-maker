...
/* This is essentially a copy-and-paste of the cryptoutils package on pub,
 * but modified to not use dart:mirrors (which bloats the size of the generated javascript)
 * and to only contain what is needed (or seems likely to be needed) for this project.
 */
